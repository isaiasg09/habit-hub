  ...
  return (
    <div className='w-full max-w-3xl mx-auto flex items-center justify-between'>
      ...
      <Dialog.Root>
        <Dialog.Trigger
          type='button'
          className='border border-blue-500 font-semibold rounded-lg px-6 py-4 flex items-center gap-3 transition-all hover:border-blue-300 '
        >
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className='absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white'>
            <Dialog.Close className='absolute right-6 top-6 text-zinc-400 transition-all hover:text-zinc-200'>
